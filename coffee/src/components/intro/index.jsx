...
<h1 className=' pb-[15px] leading-6 tracking-[4px] font-medium text-intro'>style destination</h1>
<h2 className='pb-[15px] text-[30px] small:text-[35px] sm:text-[45px] md:text-[55px] lg:text-[65px]  text-white leading-[1.2]'>life begin after coffee</h2>
<h3 className='leading-6 pb-[15px] text-intro text-[20px]'>style destination</h3>
</div>
