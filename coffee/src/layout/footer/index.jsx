...
"Clothings"
  ...
  <div className='pr-[15px] pl-[15px] md:col-span-12 md:items-center md:text-center border-none flex flex-col justify-start items-start pt-[50px] pb-[40px] lg:border-r border-footerborder '>
...
<div className="flex text-m text-black mt-[30px]">
  ...
  <div className="pl-[30px] pt-[50px] pb-[40px] border-r border-footerborder  sm:text-center">
    <div>
...
quick shop      </h4>
  ...
  <div className="pl-[30px] pr-[15px] pt-[50px] pb-[40px] sm:text-center">
  <h4 className={`text-black text-[18px] capitalize ${styles.footerclmn}`}>
company</h4>
      <div className='mt-[30px]'>
