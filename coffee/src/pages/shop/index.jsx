...
const Products = () => {
  ...
  const { data, isLoading, isError, error } = useQuery({
    ...
    queryFn: async () => {
      ...
      if (sizes) {
        query += `&filters[sizes][size][$contains]=${encodeURIComponent(sizes)}`;
      }
  ...
  const filteredProducts = data?.data?.filter((shop) => {
  ...
  {filteredProducts && filteredProducts.length > 0 ? (
    ...
    <div className="col-span-full px-[15px]  font-sofia text-base mb-[15px] pb-[16px] text-newstext">
...
{filteredProducts && filteredProducts.length > 0 && (
        <div className="flex justify-center mt-[50px] mb-[15px] pb-[20px]">
          ...
          <button
            ...
            className={`w-[42px] seredina font-sofia h-[42px] border border-[#e3e3e3]  leading-[43px] text-center inline-block text-[18px] font-medium ${currentPage === 1
          ...
          <button
            ...
            className={`w-[42px] seredina font-sofia h-[42px] border border-[#e3e3e3] leading-[43px] text-center inline-block text-[18px] font-medium ${currentPage === 2
                ? "text-white bg-newstext"
                : "text-newstext bg-transparent hover:text-white hover:bg-newstext"
              } mr-[9px]`}
          >
