...
const Logo = ({ inHeader = false }) => {
  ...
  return (
      ...
      <Link to="/" className="block" aria-label="Monfee Home">
        ...
        d="M22.8,19.5c1.2,0.1,2.4,0.2,3.7,0.2c0.3,0,0.7-0.2,0.9-0.5c3.1-4.3,6.8-8,11-11.1c2.3-1.7,4.8-3.2,7.5-4.5
          ...
          <text
            x="104.9399"
            y="-213.9098"
            className={`${fillClass} font-bold text-[48px] tracking-[2px]`}
          >
            MONFEE
          </text>
	...
	<path className={fillClass} d="M145.1,26v32.4c0,1,0.5,1.7,1.5,2c1,0.3,1.5,0.9,1.5,1.6c0,0.8-0.4,1.2-1.3,1.2h-9.9c-0.9,0-1.3-0.4-1.3-1.2
	...
	<path className={fillClass} d="M168,34.2c4,0.2,7.4,1.7,10.1,4.6c2.7,2.9,4.1,6.3,4.2,10.3v0.2c0,4-1.4,7.4-4.3,10.2
	...
	<path className={fillClass} d="M195.3,36.9c0.4-0.1,1-0.4,1.8-0.7c0.8-0.3,1.6-0.6,2.3-0.8c1.9-0.7,3.8-1.1,5.8-1.3c0.3,0,0.5,0,0.8,0
	...
	<path className={fillClass} d="M231.4,32.7v1.7l6.2-0.1h0c0.8,0,1.2,0.4,1.2,1.3c0,0.3,0,0.7-0.1,1.1c-0.3,1.2-1,1.9-2,1.9l-5.2,0v19.9
	...
	<path className={fillClass} d="M241.3,46.5c0.6-3.7,2.1-6.7,4.5-9c2.4-2.3,5.7-3.4,9.7-3.5h0.1c4.1,0,7.2,1.2,9.4,3.5c2.1,2.3,3.2,5.3,3.2,9
	...
	<path className={fillClass} d="M271.2,46.5c0.6-3.7,2.1-6.7,4.5-9c2.4-2.3,5.7-3.4,9.7-3.5h0.1c4.1,0,7.2,1.2,9.4,3.5c2.1,2.3,3.2,5.3,3.2,9
		c0,0.8-0.1,1.4-0.1,2c-0.1,0.5-0.7,0.8-1.9,0.8h-17.8c0.1,2.7,0.8,5,2.3,6.9c1.4,2,3.2,3.1,5.4,3.6c0.6,0.1,1.3,0.2,1.9,0.2
		c1.7,0,3.5-0.5,5.3-1.5c1.2-0.7,2.1-1,2.7-1c0.3,0,0.5,0.1,0.8,0.2c0.2,0.2,0.3,0.4,0.3,0.7c0,0.3-0.1,0.8-0.4,1.3
		c-0.3,0.5-0.5,0.9-0.6,1c-0.2,0.2-0.3,0.3-0.5,0.5c-2.3,2-5.3,2.9-9.2,2.9c-5.4,0-9.4-1.7-12-5.1c-2.1-2.6-3.1-5.7-3.1-9.2
		...
		C278.9,42.3,278.3,44.1,278.2,46z"></path>
          ...
          <text
            x="104.9396"
            y="-152.2828"
            className={`${fillClass} font-bold text-[60px]`}
          >
            Monfee
          </text>
        </svg>
