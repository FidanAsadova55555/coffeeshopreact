...
export interface ApiIntropictureIntropicture
  extends Struct.CollectionTypeSchema {
  collectionName: 'intropictures';
  info: {
    displayName: 'intropicture';
    pluralName: 'intropictures';
    singularName: 'intropicture';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiNewscardNewscard extends Struct.CollectionTypeSchema {
  collectionName: 'newscards';
  info: {
    description: '';
    displayName: 'newscard';
    pluralName: 'newscards';
    singularName: 'newscard';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiSecondproductSecondproduct
  extends Struct.CollectionTypeSchema {
  collectionName: 'secondproducts';
  info: {
    displayName: 'secondproduct';
    pluralName: 'secondproducts';
    singularName: 'secondproduct';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::secondproduct.secondproduct'
    > &
      Schema.Attribute.Private;
    newprice: Schema.Attribute.Decimal;
    old: Schema.Attribute.Decimal;
...
export interface ApiThirdproductThirdproduct
  extends Struct.CollectionTypeSchema {
  collectionName: 'thirdproducts';
  info: {
    displayName: 'thirdproduct';
    pluralName: 'thirdproducts';
    singularName: 'thirdproduct';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::newscard.newscard': ApiNewscardNewscard;
